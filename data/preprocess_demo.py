...
params = {
    ...
    'step': 4*24*3,    # step=4/h*24h/day*3day means to calculate the missing rate three days backward at each moment
    'ms_thresh': 0.2,   # the condition of missing rate (< ms_thresh) for multiple data
    # parameters of remove outliers
    'win_size': 4*24*3,   # win_size=sampling_rate/h*24h/day*7day, time window size of remove outliers
...
# process.process(oldt_method='3-sigma', impute_method='linear')
